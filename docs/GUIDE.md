# Deep VQA Framework — 文档中心

> 本文档作为项目文档总入口，主要提供各模块文档的快速跳转。
...
| **EDA 子模块** | [src/data/eda/GUIDE.md](../src/data/eda/GUIDE.md) | 数据探索与分析详细说明（integrity、statistics、split、metrics_plotter） |
